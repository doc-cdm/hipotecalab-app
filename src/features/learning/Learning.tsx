    ...
    <div className="h-full flex flex-col max-w-5xl mx-auto p-4 space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-lg p-4 flex flex-col">
          ...
          <div className="flex items-end justify-between mt-1">
            <span className="text-2xl font-bold text-orange-400">{progress.achievements.length}</span>
        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-lg p-4 flex flex-col">
          ...
          <button onClick={() => { if (confirm('¿Reiniciar progreso?')) resetProgress(); }} className="mt-auto text-[10px] text-slate-400 underline hover:text-orange-400">Reiniciar</button>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2 items-center justify-center">
        <button onClick={siguiente} className="px-4 py-2 rounded-md text-sm font-medium border border-slate-600 hover:border-orange-400/60 hover:bg-slate-700/50">
          Nueva Pregunta
        </button>
      </div>
